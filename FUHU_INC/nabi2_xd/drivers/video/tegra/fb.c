...
//&*&*&*SJ1_20130312, fix android recovery mode portrait screen ui issue on kai_16r7.1
//if (!info->fix.line_length)
//&*&*&*SJ2_20130312, fix android recovery mode portrait screen ui issue on kai_16r7.1
		{
