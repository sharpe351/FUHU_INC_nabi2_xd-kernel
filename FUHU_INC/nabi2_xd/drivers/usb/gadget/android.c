...
#define STRING_INTERFACE_IDX    3	//&*&*&*SJ_20120806
...
//&*&*&*SJ1_20120806, add string description of the ADB interface.
	[STRING_INTERFACE_IDX].s = "Android Composite ADB Interface",
//&*&*&*SJ2_20120806
	{  }			/* end of list */
};
...
//&*&*&*SJ1_20120806, add string description of the ADB interface.
	id = usb_string_id(cdev);
	if (id < 0) return id;
	strings_dev[STRING_INTERFACE_IDX].id = id;
//&*&*&*SJ2_20120806
