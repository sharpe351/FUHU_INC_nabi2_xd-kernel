...
static int __init nabijr_board_strap(char *code)
{
	char *p = code;
...
int nabijr_get_board_strap(void)
{
	return board_strap;
}
EXPORT_SYMBOL(nabijr_get_board_strap);

__setup("androidboot.board_strap=", nabijr_board_strap);
