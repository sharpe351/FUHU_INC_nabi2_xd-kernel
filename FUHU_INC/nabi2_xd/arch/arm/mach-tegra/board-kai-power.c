...
static struct regulator_consumer_supply max77663_ldo5_supply[] = {
	...
	REGULATOR_SUPPLY("core_vdd_lcm", NULL),
};
//NXD-
...
static struct regulator_consumer_supply max77663_ldo7_supply[] = {
	...
	REGULATOR_SUPPLY("lcm_mipi", NULL),
};
//NXD-
...
MAX77663_PDATA_INIT(ldo5, 800000, 2800000, NULL, 0, 0, 0,
		    0, 0, -1, FPS_SRC_NONE, -1, -1, 0);
*/
/* NXD for LCM power */ /*JimmySu modify for NXD initial setting*/
MAX77663_PDATA_INIT(ldo5, 1200000, 1200000, NULL, 0, 0, 0,
		    1, 1/*0*/, 1200000, FPS_SRC_NONE, -1, -1, 0);
#endif
//&*&*&*HC2_20130129
...
#else //NJ5
MAX77663_PDATA_INIT(ldo6, 800000, 3950000, NULL, 0, 0, 0,
		    1, 0, 3300000, FPS_SRC_NONE, -1, -1, 0);
#endif
//&*&*&*SJ2_20130321


/* NXD for DSI power *//*JimmySu modify for NXD initial setting*/
MAX77663_PDATA_INIT(ldo7, 800000, 3950000, max77663_rails(sd3), 0, 0, 0,
		    1/*0*/, 1/*0*/, 1200000/*-1*/, FPS_SRC_NONE, -1, -1, 0);
...
//&*&*&*HC1_20130222, remove the camera power source since it is controlled by GPIO
/*
static struct regulator_consumer_supply fixed_reg_en_cam2_ldo_supply[] = {
	REGULATOR_SUPPLY("vdd_cam2", NULL),
};
*/
//&*&*&*HC2_20130222, remove the camera power source since it is controlled by GPIO
//NJ5-
...
/*FIXED_REG(3, en_1v8_cam_a01,	en_1v8_cam,		max77663_rails(sd2),
	0,	0,	TEGRA_GPIO_PS0,				true,	0,	1800);*/
FIXED_REG(4, en_vdd_pnl_a01,	en_vdd_pnl,		FIXED_SUPPLY(en_3v3_sys_a01),
	0,	1,	TEGRA_GPIO_PW1,				true,	0,	3300);
/*FIXED_REG(5, en_cam2_ldo_a01,	en_cam2_ldo,		NULL,
	0,	0,	TEGRA_GPIO_PR7,				true,	0,	2800);*/
FIXED_REG(6,  en_vdd_sdmmc1_a01, en_vdd_sdmmc1,		FIXED_SUPPLY(en_3v3_sys_a01),
	0,	0,	TEGRA_GPIO_PC6,				true,	0,	3300);
FIXED_REG(7, en_3v3_fuse_a01,	en_3v3_fuse,		FIXED_SUPPLY(en_3v3_sys_a01),
	0,	0,	TEGRA_GPIO_PC1,				true,	0,	3300);
//&*&*&*HC2_20130104
//&*&*&*HC2_20130222, remove the camera power source since it is controlled by GPIO
