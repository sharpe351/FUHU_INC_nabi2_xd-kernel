...
/* SASKEN ::
	Moved the following registers from tlv320aic325x.h
	as part of the MFD changes
*/
/* #define AIC3256_AIC3XXX_MAKE_REG(0, page, offset) \
	((unsigned int)((page<<8) | offset ) & 0x0000ffff) */
/* ****************** Page 0 Registers **************************************/
...
#if 0
/* SASKEN:: Need to map the following registers with 3256 codec dstasheet */
