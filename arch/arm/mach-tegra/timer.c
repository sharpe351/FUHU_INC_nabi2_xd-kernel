...
//&*&*&*HC1_20130628, add NV's patch
/*
*
* Subject: ARM: tegra: timer: Fix time moving backwards in suspend/resume test
*             read_persistent_clock uses a spinlock to ensure non-atomic updates.
*             It ensures time fetched from RTC register would not move backwards.
*
*/
static DEFINE_SPINLOCK(read_persistent_clock_lock);
//&*&*&*HC2_20130628, add NV's patch
