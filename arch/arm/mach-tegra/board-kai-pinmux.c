...
static __initdata struct tegra_pingroup_config kai_pinmux_common[] = {
	...
	/* FUHU Connector UART dual layout*/
	/* UART D : DEBUG */
	...
	/* SPI1 : TLV320AIC3256 audio Codec */
	...
	/* RAM Strap for different BCT selection */
	/* RAM_CODE */
	DEFAULT_PINMUX(GMI_AD4,         RSVD1,           NORMAL,    TRISTATE,     INPUT),
	/* RAM_CODE1 */
	DEFAULT_PINMUX(GMI_AD5,         RSVD1,           NORMAL,    TRISTATE,     INPUT),
	
	/* RECOVERY Function Pins */
	/* NAND_ALE */
	DEFAULT_PINMUX(GMI_ADV_N,       RSVD1,         NORMAL,    TRISTATE,    INPUT),
	/* NAND_CLE */
	DEFAULT_PINMUX(GMI_CLK,         RSVD1,           NORMAL,   TRISTATE,     INPUT),	
	/* NAND_RE */
	DEFAULT_PINMUX(GMI_OE_N,        RSVD1,         NORMAL,    TRISTATE,   INPUT),
	/* NAND_WE */
	DEFAULT_PINMUX(GMI_WR_N,        RSVD1,         NORMAL,    TRISTATE,   INPUT),

	/* BOARD STRAP for HW ID */
	/* Board_STRAP_0, GPIO_PK3 */
	DEFAULT_PINMUX(GMI_CS2_N,       RSVD1,           NORMAL,    TRISTATE,     INPUT),
	/* Board_STRAP_1, GPIO_PK2 */
	DEFAULT_PINMUX(GMI_CS4_N,       RSVD1,         NORMAL,    TRISTATE,   INPUT),
	/* Board_STRAP_2, GPIO_PI3 */
	DEFAULT_PINMUX(GMI_CS6_N,       NAND,          NORMAL,    TRISTATE,   INPUT),
	...
	/* WIFI GPIO */
	/* WF_WOW_AUX*, GPIO_PW3, WIFI BCM4330 OOB */
	...
	/* VDD_2V8_REAR_VCM_EN, GPIO_PS6 */	
	DEFAULT_PINMUX(KB_ROW14,        KBC,             NORMAL,    NORMAL,   	OUTPUT),
	/* VDD_2V8_REAR_CAM_EN, GPIO_PS7 */	
	...
	/* EN_CHARGER_LED_R, GPIO_PN1 */
	DEFAULT_PINMUX(DAP1_DIN,        I2S0,            NORMAL,    NORMAL,     OUTPUT),
	/* EN_CHARGER_LED_G, GPIO_PN2 */
	DEFAULT_PINMUX(DAP1_DOUT,       I2S0,            NORMAL,    NORMAL,     OUTPUT),

	/* SENSOR GPIO */
	/* TEMP_ALERT*, option for external temperature sensor (NM) */ 
	DEFAULT_PINMUX(KB_ROW11,        KBC,             PULL_UP,   TRISTATE,   INPUT),
	/* G_sensor_INT, GPIO_PQ5 */	
	DEFAULT_PINMUX(KB_COL5,         KBC,           NORMAL,    TRISTATE,   INPUT),

	/* POWER RAIL GPIO */
	/* CAM2_LDO_EN, GPIO_PR7 */
	DEFAULT_PINMUX(KB_ROW7,         KBC,             NORMAL,    NORMAL,     OUTPUT),
	/* EN_VDD_PNL1_Lcd, GPIO_PW1 */
	DEFAULT_PINMUX(LCD_M1,          DISPLAYA,        NORMAL,    NORMAL,     OUTPUT),
	/* EN_3V3_FUSE_Lcd, GPIO_PC1 */
	DEFAULT_PINMUX(LCD_PWR1,        DISPLAYA,        NORMAL,    NORMAL,     OUTPUT),
	/* EN_VDD_SDMMC1_Lcd, GPIO_PC6 */
	DEFAULT_PINMUX(LCD_PWR2,        DISPLAYA,        NORMAL,    NORMAL,     OUTPUT),
	/* EN_1V8_CAM, GPIO_PS0 */
	DEFAULT_PINMUX(KB_ROW8,         KBC,             NORMAL,    NORMAL,     OUTPUT),
	/* LCD_VDD_EN_3V3, GPIO_PI7 */	
	DEFAULT_PINMUX(GMI_WAIT,        RSVD1,	       	 NORMAL,    NORMAL,   	OUTPUT),
	
	/* EN_VDD_PNL1_Audio is backup pins to control power */
	/* EN_VDD_PNL1_Audio, GPIO_PN0 */
	DEFAULT_PINMUX(DAP1_FS,         I2S0,            NORMAL,    NORMAL,     OUTPUT),

	/* FUHU Connector */
	/* Docking_Det, GPIO_PJ2 */
	DEFAULT_PINMUX(GMI_CS1_N,       RSVD1,         PULL_UP,    TRISTATE,   INPUT),
	
	/* OTHERS */	
	DEFAULT_PINMUX(CLK_32K_OUT,     BLINK,           NORMAL,    NORMAL,     OUTPUT),
	/* CLK1_OUT */
	DEFAULT_PINMUX(CLK1_OUT,        EXTPERIPH1,      NORMAL,    NORMAL,     INPUT),
	/* TD2_ID2 TO GND FOR SW COMPATIBILITY WITH EVT+RAYDIUM TOUCH */
...
static __initdata struct tegra_pingroup_config unused_pins_lowpower[] = {
	...
	DEFAULT_PINMUX(GMI_AD0,         RSVD1,           NORMAL,    TRISTATE,     OUTPUT),	
	DEFAULT_PINMUX(GMI_AD12,        NAND,            NORMAL,    TRISTATE,   	OUTPUT),
	DEFAULT_PINMUX(GMI_AD13,        NAND,            NORMAL,    TRISTATE,   	OUTPUT),	
	DEFAULT_PINMUX(GMI_AD14,        RSVD1,           NORMAL, 		TRISTATE,     OUTPUT),
	DEFAULT_PINMUX(GMI_AD15,        RSVD1,           NORMAL,   	TRISTATE,     OUTPUT),
	DEFAULT_PINMUX(GMI_AD6,         RSVD1,           NORMAL, 		TRISTATE,     OUTPUT),
	DEFAULT_PINMUX(GMI_AD7,         RSVD1,           NORMAL, 		TRISTATE,     OUTPUT),	
	DEFAULT_PINMUX(GMI_AD9,         RSVD2,           NORMAL,    TRISTATE,     OUTPUT),
	DEFAULT_PINMUX(GMI_CS0_N,       RSVD1,         	 NORMAL,    TRISTATE,   	OUTPUT),
	DEFAULT_PINMUX(GMI_CS3_N,       RSVD1,           NORMAL,    TRISTATE,     OUTPUT),
	...
	DEFAULT_PINMUX(LCD_CS0_N,       DISPLAYA,        NORMAL,    TRISTATE,     OUTPUT),
	DEFAULT_PINMUX(LCD_CS1_N,       DISPLAYA,        NORMAL,    TRISTATE,     OUTPUT),
	DEFAULT_PINMUX(LCD_SCK,         DISPLAYA,        NORMAL,    TRISTATE,     OUTPUT),
	DEFAULT_PINMUX(LCD_WR_N,        DISPLAYA,        NORMAL,   TRISTATE,     OUTPUT),

	/* VDDIO_PEX_CTL */
	/* Not Available on T30S - Start*/
	...
	/* VDDIO_SYS */
	DEFAULT_PINMUX(KB_COL2,         KBC,             NORMAL,   	TRISTATE,     OUTPUT),
	...
	/* VDDIO_UART */	
	DEFAULT_PINMUX(GPIO_PU4,        PWM1,            NORMAL,    TRISTATE,     OUTPUT),
	DEFAULT_PINMUX(GPIO_PU5,        PWM2,            NORMAL,    TRISTATE,     OUTPUT),
